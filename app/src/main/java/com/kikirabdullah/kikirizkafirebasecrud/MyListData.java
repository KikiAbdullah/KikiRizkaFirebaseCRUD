package com.kikirabdullah.kikirizkafirebasecrud;
...
import com.kikirabdullah.kikirizkafirebasecrud.adapter.RecyclerViewAdapter;
import com.kikirabdullah.kikirizkafirebasecrud.models.data_mahasiswa;

public class MyListData<RecyclerView> extends AppCompatActivity implements RecyclerViewAdapter.dataListener {
    ...
    private DatabaseReferencence reference;
